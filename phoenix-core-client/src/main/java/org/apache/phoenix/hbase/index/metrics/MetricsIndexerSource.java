...
public interface MetricsIndexerSource extends BaseSource {
  ...
  String INDEX_PREPARE_TIME_DESC =
    "Histogram for the time in milliseconds for preparing an index write";
  String SLOW_INDEX_PREPARE = "slowIndexPrepareCalls";
  String SLOW_INDEX_PREPARE_DESC =
    "The number of index preparations slower than the configured threshold";

  String INDEX_WRITE_TIME = "indexWriteTime";
  String INDEX_WRITE_TIME_DESC =
    "Histogram for the time in milliseconds for writing an index update";
  ...
  String DUPLICATE_KEY_TIME_DESC =
    "Histogram for the time in milliseconds to handle ON DUPLICATE keywords";
  ...
  String SLOW_PRE_WAL_RESTORE_DESC =
    "The number of preWALRestore calls slower than the configured threshold";
  ...
  String SLOW_POST_DELETE_DESC =
    "The number of postDelete calls slower than the configured threshold";
  ...
  String PRE_INDEX_UPDATE_TIME_DESC =
    "Histogram for the time in milliseconds for index updates pre data updates";
  String POST_INDEX_UPDATE_TIME = "postIndexUpdateTime";
  String POST_INDEX_UPDATE_TIME_DESC =
    "Histogram for the time in milliseconds for index updates post data updates";

  String PRE_INDEX_UPDATE_FAILURE_TIME = "preIndexUpdateFailureTime";
  String PRE_INDEX_UPDATE_FAILURE_TIME_DESC =
    "Histogram for the time in milliseconds on failures of index updates pre data updates";
  String POST_INDEX_UPDATE_FAILURE_TIME = "postIndexUpdateFailureTime";
  String POST_INDEX_UPDATE_FAILURE_TIME_DESC =
    "Histogram for the time in milliseconds on failures of index updates post data updates";
  ...
  /**
   * @param dataTableName Physical data table name Increments the number of slow calls prepare an
   *                      index write.
   */
