...
public class PhoenixDatabaseMetaData implements DatabaseMetaData {
  ...
  public static final String SYSTEM_CATALOG =
  ...
  public static final String MAPPED_SYSTEM_CATALOG_NAME =
    SYSTEM_CATALOG_NAME.replace(QueryConstants.NAME_SEPARATOR, QueryConstants.NAMESPACE_SEPARATOR);
  ...
  public static final String SYSTEM_SEQUENCE =
    SYSTEM_CATALOG_SCHEMA + ".\"" + SYSTEM_SEQUENCE_TABLE + "\"";
  ...
  public static final byte[] DEFAULT_COLUMN_FAMILY_NAME_BYTES =
    Bytes.toBytes(DEFAULT_COLUMN_FAMILY_NAME);
  ...
  public static final String SYSTEM_FUNCTION =
    SYSTEM_CATALOG_SCHEMA + QueryConstants.NAME_SEPARATOR + "\"FUNCTION\"";
  ...
  public static final String SYSTEM_MUTEX_NAME =
    SchemaUtil.getTableName(QueryConstants.SYSTEM_SCHEMA_NAME, SYSTEM_MUTEX_TABLE_NAME);
  ...
  public static final int TTL_DEFINED_IN_TABLE_DESCRIPTOR = -1;
  ...
  public static final String SYSTEM_TASK_NAME =
  ...
  public static final TableName SYSTEM_HA_GROUP_HBASE_TABLE_NAME =
  ...
  private PhoenixResultSet getEmptyResultSet() throws SQLException {
    ...
    return new PhoenixResultSet(ResultIterator.EMPTY_ITERATOR, RowProjector.EMPTY_PROJECTOR,
  ...
  private static final PColumnImpl TENANT_ID_COLUMN =
    new PColumnImpl(PNameFactory.newName(TENANT_ID), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, DATA_TYPE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl TABLE_SCHEM_COLUMN =
    new PColumnImpl(PNameFactory.newName(TABLE_SCHEM), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, DATA_TYPE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl TABLE_NAME_COLUMN =
    new PColumnImpl(PNameFactory.newName(TABLE_NAME), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, DATA_TYPE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl COLUMN_NAME_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_NAME), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, DATA_TYPE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl DATA_TYPE_COLUMN =
    new PColumnImpl(PNameFactory.newName(DATA_TYPE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, DATA_TYPE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl TYPE_NAME_COLUMN =
    new PColumnImpl(PNameFactory.newName(TYPE_NAME), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(TYPE_NAME), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl COLUMN_SIZE_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_SIZE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, COLUMN_SIZE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl BUFFER_LENGTH_COLUMN =
    new PColumnImpl(PNameFactory.newName(BUFFER_LENGTH), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(BUFFER_LENGTH), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl DECIMAL_DIGITS_COLUMN =
    new PColumnImpl(PNameFactory.newName(DECIMAL_DIGITS), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, DECIMAL_DIGITS_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl NUM_PREC_RADIX_COLUMN =
    new PColumnImpl(PNameFactory.newName(NUM_PREC_RADIX), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(NUM_PREC_RADIX), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl NULLABLE_COLUMN =
    new PColumnImpl(PNameFactory.newName(NULLABLE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, NULLABLE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl REMARKS_COLUMN =
    new PColumnImpl(PNameFactory.newName(REMARKS), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(REMARKS), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl COLUMN_DEF_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_DEF), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(COLUMN_DEF), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl SQL_DATA_TYPE_COLUMN =
    new PColumnImpl(PNameFactory.newName(SQL_DATA_TYPE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(SQL_DATA_TYPE), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl SQL_DATETIME_SUB_COLUMN = new PColumnImpl(
    PNameFactory.newName(SQL_DATETIME_SUB), PNameFactory.newName(TABLE_FAMILY_BYTES),
    PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
    false, Bytes.toBytes(SQL_DATETIME_SUB), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl CHAR_OCTET_LENGTH_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_SIZE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(CHAR_OCTET_LENGTH), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl ORDINAL_POSITION_COLUMN = new PColumnImpl(
    PNameFactory.newName(ORDINAL_POSITION), PNameFactory.newName(TABLE_FAMILY_BYTES),
    PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
    false, ORDINAL_POSITION_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl IS_NULLABLE_COLUMN =
    new PColumnImpl(PNameFactory.newName(IS_NULLABLE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(IS_NULLABLE), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl SCOPE_CATALOG_COLUMN =
    new PColumnImpl(PNameFactory.newName(SCOPE_CATALOG), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(SCOPE_CATALOG), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl SCOPE_SCHEMA_COLUMN =
    new PColumnImpl(PNameFactory.newName(SCOPE_SCHEMA), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(SCOPE_SCHEMA), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl SCOPE_TABLE_COLUMN =
    new PColumnImpl(PNameFactory.newName(SCOPE_TABLE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(SCOPE_TABLE), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl SOURCE_DATA_TYPE_COLUMN = new PColumnImpl(
    PNameFactory.newName(SOURCE_DATA_TYPE), PNameFactory.newName(TABLE_FAMILY_BYTES),
    PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
    false, Bytes.toBytes(SOURCE_DATA_TYPE), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl IS_AUTOINCREMENT_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_SIZE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PSmallint.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(SCOPE_CATALOG), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl ARRAY_SIZE_COLUMN =
    new PColumnImpl(PNameFactory.newName(ARRAY_SIZE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, ARRAY_SIZE_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl COLUMN_FAMILY_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_FAMILY), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, COLUMN_FAMILY_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl TYPE_ID_COLUMN =
    new PColumnImpl(PNameFactory.newName(COLUMN_SIZE), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PInteger.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, Bytes.toBytes(TYPE_ID), HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl VIEW_CONSTANT_COLUMN =
    new PColumnImpl(PNameFactory.newName(VIEW_CONSTANT), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarbinary.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null,
      false, false, VIEW_CONSTANT_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl MULTI_TENANT_COLUMN =
    new PColumnImpl(PNameFactory.newName(MULTI_TENANT), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PBoolean.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, MULTI_TENANT_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl KEY_SEQ_COLUMN =
    new PColumnImpl(PNameFactory.newName(KEY_SEQ), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PSmallint.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, KEY_SEQ_BYTES, HConstants.LATEST_TIMESTAMP);
  private static final PColumnImpl PK_NAME_COLUMN =
    new PColumnImpl(PNameFactory.newName(PK_NAME), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, PK_NAME_BYTES, HConstants.LATEST_TIMESTAMP);
  public static final String ASC_OR_DESC = "ASC_OR_DESC";
  public static final byte[] ASC_OR_DESC_BYTES = Bytes.toBytes(ASC_OR_DESC);
  private static final PColumnImpl ASC_OR_DESC_COLUMN =
    new PColumnImpl(PNameFactory.newName(ASC_OR_DESC), PNameFactory.newName(TABLE_FAMILY_BYTES),
      PVarchar.INSTANCE, null, null, false, 1, SortOrder.getDefault(), 0, null, false, null, false,
      false, ASC_OR_DESC_BYTES, HConstants.LATEST_TIMESTAMP);

  private static final List<PColumnImpl> PK_DATUM_LIST =
    Lists.newArrayList(TENANT_ID_COLUMN, TABLE_SCHEM_COLUMN, TABLE_NAME_COLUMN, COLUMN_NAME_COLUMN);

  private static final RowProjector GET_COLUMNS_ROW_PROJECTOR =
    new RowProjector(
      Arrays.<
        ColumnProjector> asList(
          new ExpressionProjector(TABLE_CAT, TABLE_CAT, SYSTEM_CATALOG,
            new RowKeyColumnExpression(TENANT_ID_COLUMN, new RowKeyValueAccessor(PK_DATUM_LIST, 0)),
            false),
  ...
  private boolean match(String str, String pattern) throws SQLException {
    LiteralExpression strExpr =
      LiteralExpression.newConstant(str, PVarchar.INSTANCE, SortOrder.ASC);
    LiteralExpression patternExpr =
      LiteralExpression.newConstant(pattern, PVarchar.INSTANCE, SortOrder.ASC);
  ...
  public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
    ...
    try {
      ...
      try (ResultSet rs = getTables(catalog, schemaPattern, tableNamePattern, null)) {
        while (rs.next()) {
          ...
          for (PColumn column : columns) {
            if (
              isTenantSpecificConnection && column.equals(table.getPKColumns().get(startOffset))
            ) {
            ...
            String columnFamily =
              column.getFamilyName() != null ? column.getFamilyName().getString() : null;
            String columnName = column.getName().getString();
            if (cfPattern != null && cfPattern.length() > 0) { // if null or empty, will pick up all
                                                               // columns
            ...
            // TYPE_NAME
            cells.add(
              PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, Bytes.toBytes(TYPE_NAME),
                MetaDataProtocol.MIN_TABLE_TIMESTAMP, column.getDataType().getSqlTypeNameBytes()));
            // COLUMN_SIZE
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, COLUMN_SIZE_BYTES,
              MetaDataProtocol.MIN_TABLE_TIMESTAMP,
            ...
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES,
              ...
              column.getScale() != null
                ? PInteger.INSTANCE.toBytes(column.getScale())
                : ByteUtil.EMPTY_BYTE_ARRAY));
            // NUM_PREC_RADIX
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES,
              ...
              ByteUtil.EMPTY_BYTE_ARRAY));
            // NULLABLE
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, NULLABLE_BYTES,
              MetaDataProtocol.MIN_TABLE_TIMESTAMP,
              PInteger.INSTANCE.toBytes(SchemaUtil.getIsNullableInt(column.isNullable()))));
            // REMARKS
            cells.add(
              PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, Bytes.toBytes(REMARKS),
            ...
            cells.add(
              PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, ORDINAL_POSITION_BYTES,
            ...
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES,
              ...
              ByteUtil.EMPTY_BYTE_ARRAY));
            // ARRAY_SIZE
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, ARRAY_SIZE_BYTES,
              MetaDataProtocol.MIN_TABLE_TIMESTAMP,
      ...
      PhoenixStatement stmt = new PhoenixStatement(connection);
      stmt.closeOnCompletion();
      return new PhoenixResultSet(new MaterializedResultIterator(tuples), GET_COLUMNS_ROW_PROJECTOR,
        new StatementContext(stmt, false));
    } finally {
  ...
  public String getDatabaseProductVersion() throws SQLException {
    return Integer.toString(getDatabaseMajorVersion()) + "."
      + Integer.toString(getDatabaseMinorVersion());
  }
  ...
  public String getDriverVersion() throws SQLException {
    return connection.getClientInfo(PhoenixEmbeddedDriver.MAJOR_VERSION_PROP) + "."
      + connection.getClientInfo(PhoenixEmbeddedDriver.MINOR_VERSION_PROP);
  }
  ...
  public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique,
    ...
    PreparedStatement stmt =
      QueryUtil.getIndexInfoStmt(connection, catalog, schema, table, unique, approximate);
    if (stmt == null) {
      return getEmptyResultSet();
    }
    stmt.closeOnCompletion();
        ...
        while (rs.next()) {
          ...
          for (PColumn column : sorderPkColumns) {
            ...
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, PK_NAME_BYTES,
              MetaDataProtocol.MIN_TABLE_TIMESTAMP,
              table.getPKName() != null
                ? table.getPKName().getBytes()
                : ByteUtil.EMPTY_BYTE_ARRAY));
            // ASC_OR_DESC
            char sortOrder = column.getSortOrder() == SortOrder.ASC ? 'A' : 'D';
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, ASC_OR_DESC_BYTES,
              MetaDataProtocol.MIN_TABLE_TIMESTAMP, Bytes.toBytes(sortOrder)));
            // DATA_TYPE
            cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, DATA_TYPE_BYTES,
              MetaDataProtocol.MIN_TABLE_TIMESTAMP,
              PInteger.INSTANCE.toBytes(column.getDataType().getResultSetSqlType())));
  ...
  public ResultSet getSuperTables(String catalog, String schemaPattern, String tableNamePattern)
    throws SQLException {
    PreparedStatement stmt =
      QueryUtil.getSuperTablesStmt(connection, catalog, schemaPattern, tableNamePattern);
    stmt.closeOnCompletion();
    return stmt.executeQuery();
  }
  ...
  private static final RowProjector TABLE_TYPE_ROW_PROJECTOR = new RowProjector(
    Arrays.<ColumnProjector> asList(new ExpressionProjector(TABLE_TYPE, TABLE_TYPE, SYSTEM_CATALOG,
      new RowKeyColumnExpression(TABLE_TYPE_DATUM,
        new RowKeyValueAccessor(Collections.<PDatum> singletonList(TABLE_TYPE_DATUM), 0)),
      false)),
    0, true);
  private static final Collection<Tuple> TABLE_TYPE_TUPLES =
    Lists.newArrayListWithExpectedSize(PTableType.values().length);
  static {
    List<byte[]> tableTypes = Lists.<byte[]> newArrayList(PTableType.INDEX.getValue().getBytes(),
      Bytes.toBytes(SEQUENCE_TABLE_TYPE), PTableType.SYSTEM.getValue().getBytes(),
      PTableType.TABLE.getValue().getBytes(), PTableType.VIEW.getValue().getBytes());
    for (byte[] tableType : tableTypes) {
      TABLE_TYPE_TUPLES
        .add(new SingleKeyValueTuple(PhoenixKeyValueUtil.newKeyValue(tableType, TABLE_FAMILY_BYTES,
          TABLE_TYPE_BYTES, MetaDataProtocol.MIN_TABLE_TIMESTAMP, ByteUtil.EMPTY_BYTE_ARRAY)));
    }
  }
  ...
  public ResultSet getTableTypes() throws SQLException {
    PhoenixStatement stmt = new PhoenixStatement(connection);
    stmt.closeOnCompletion();
    return new PhoenixResultSet(new MaterializedResultIterator(TABLE_TYPE_TUPLES),
      TABLE_TYPE_ROW_PROJECTOR, new StatementContext(stmt, false));
  }
  ...
  public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern,
    ...
    PreparedStatement stmt =
      QueryUtil.getTablesStmt(connection, catalog, schemaPattern, tableNamePattern, types);
    if (stmt == null) {
      return getEmptyResultSet();
    }
    stmt.closeOnCompletion();
