...
public class ClusterRoleRecordTest {
  ...
  public void testReadWriteJsonToFile() throws IOException {
    ClusterRoleRecord record = getClusterRoleRecord(testName.getMethodName(),
      HighAvailabilityPolicy.FAILOVER, URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 1);
  ...
  public void testUrlNullInRoleRecord() throws IOException {
    ...
    Optional<ClusterRoleRecord> recordWithNullRole =
      ClusterRoleRecord.fromJson(roleRecordWithWrongRole);
  ...
  public void testGetActiveUrl() {
    ClusterRoleRecord record = getClusterRoleRecord(testName.getMethodName(),
      HighAvailabilityPolicy.FAILOVER, URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 0);
    assertTrue(record.getActiveUrl().isPresent());
    assertEquals(getUrlWithSuffix(URL1), record.getActiveUrl().get());

    record = getClusterRoleRecord(testName.getMethodName(), HighAvailabilityPolicy.FAILOVER, URL1,
      ClusterRole.STANDBY, URL2, ClusterRole.STANDBY, 0);
  ...
  public void testIsNewerThan() {
    ...
    ClusterRoleRecord recordV0 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL1, ClusterRole.STANDBY, URL2, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL1, ClusterRole.STANDBY, URL2, ClusterRole.STANDBY, 2);
    ...
    ClusterRoleRecord record2 = getClusterRoleRecord(haGroupName2, HighAvailabilityPolicy.FAILOVER,
      URL1, ClusterRole.STANDBY, URL2, ClusterRole.STANDBY, 1);
  ...
  public void testHasSameInfo() {
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord recordV0 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 1);
  ...
  public void testHasSameInfoDifferentZKOrder() {
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord recordV0 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL2, ClusterRole.ACTIVE, URL1, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 1);
    assertTrue(recordV1.hasSameInfo(recordV0));
    assertTrue(recordV1.hasSameInfo(recordV1));
  ...
  public void testHasSameInfoDifferentHostOrder() {
    ...
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord recordV0 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      URL2, ClusterRole.ACTIVE, hostzk1ordered, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      hostzk1unordered, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 1);
    assertTrue(recordV1.hasSameInfo(recordV0));
    assertTrue(recordV1.hasSameInfo(recordV1));
    assertTrue(recordV0.hasSameInfo(recordV1));
  }
  ...
  public void testHasSameInfoNegative() {
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord record = getClusterRoleRecord(haGroupName, HighAvailabilityPolicy.PARALLEL,
      URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 0);
    ...
    String haGroupName2 = haGroupName + RandomStringUtils.randomAlphabetic(2);
    ClusterRoleRecord record2 = getClusterRoleRecord(haGroupName2, HighAvailabilityPolicy.PARALLEL,
      URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 1);
  ...
  public void testToPrettyString() {
    ClusterRoleRecord record = getClusterRoleRecord(testName.getMethodName(),
      HighAvailabilityPolicy.PARALLEL, URL1, ClusterRole.ACTIVE, URL2, ClusterRole.STANDBY, 1);
  ...
  private byte[] readFile(String fileName) throws IOException {
    InputStream inputStream =
      ClusterRoleRecordTest.class.getClassLoader().getResourceAsStream(fileName);
